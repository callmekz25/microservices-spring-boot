...
import com.codewithkz.inventoryservice.infra.rabbitmq.config.InventoryRabbitMQConfig;
...
public class InventoryEventPublisher {
    ...
    public void publishInventoryReserved(InventoryReservedEvent event) {
        ...
        rabbitTemplate.convertAndSend(
                InventoryRabbitMQConfig.INVENTORY_EXCHANGE,
                InventoryRabbitMQConfig.INVENTORY_RESERVED_ROUTING_KEY,
                event);
    }
    ...
    public void publishInventoryRejected(InventoryRejectedEvent event) {
        ...
        rabbitTemplate.convertAndSend(
                InventoryRabbitMQConfig.INVENTORY_EXCHANGE,
                InventoryRabbitMQConfig.INVENTORY_REJECTED_ROUTING_KEY,
                event);
    }
